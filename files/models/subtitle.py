    ...
    def convert_to_srt(self):
        ...
        with tempfile.TemporaryDirectory(dir=settings.TEMP_DIRECTORY) as tmpdirname:
            ...
            if list_of_files:
                ...
                # Windows 兼容：使用 shutil.copy 而不是 Unix 命令 cp
                shutil.copy(subtitles_file, input_path)
            else:
